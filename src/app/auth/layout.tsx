...
export default function AuthLayout({
  ...
  return (
    <main className="w-full flex flex-col lg:relative overflow-y-scroll bg-[url('/images/auth_bg.jpg')] bg-center bg-no-repeat bg-blend-darken bg-black/70 bg-cover transition-all">
